...
module.exports = new Plugin(
	...
	[fsPlugin, reactPlugin],
	{
		symbols: [
			...
			'ROUTER_ROUTES', 'CREATE_ROUTER_FILE', 'CREATE_ROUTER_ROOT_FILE',
	...
	(Route, {
		...
		async [INIT_CHILDREN]() {
			...
			if (this[REACT_ROOT] === this) this[CREATE_ROUTER_ROOT_FILE]();
		}
		...
		async [PRE_BUILD]() {
			...
			deleteRouteProperties(this, [
				REACT_ROUTER_FILE, REACT_ROUTER_ROOT_FILE, ROUTER_ROUTES,
				ROUTER_ADD_ROUTE, CREATE_ROUTER_FILE, CREATE_ROUTER_ROOT_FILE,
				GET_REACT_ROUTER_FILE, GET_REACT_ROUTER_ROOT_FILE
			]);
		}
	}
);
